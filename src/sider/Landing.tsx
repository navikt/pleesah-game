        ...
        <div className="container">
            ...
            <article>
                ...
                <p>
                    ...
                    Kubernetes passer på <code>deployments</code> som i vår analogi er admiraler. Hver <code>deployment</code> består av <code>pods</code> som her
                    er skuter. En admiral har altså kontroll over flere skuter, og administrerer disse.
                    En skute kan ha last som tilsvarer en eller flere <code>containere</code> i en <code>pod</code>.
