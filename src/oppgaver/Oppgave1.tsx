    ...
    return (
        <main>
            <div className="flex-column-container">
                ...
                <article>
                    <p>
                        For å kunne sjøsette skuta må du først opprette en .yaml-fil. Deretter må du kjøre en kommando
                        for å lage ressursen som er spesifisert i specen under. Dette gjør du ved å bruke{" "}
                        <code>kubectl apply</code>. Tommelfingerregelen er at apply oppretter en ny ressurs dersom den
                        ikke allerede finnes, og oppdaterer kun det som har endret seg dersom den finnes.
                    </p>
                    <pre>
                        <code>{`apiVersion: v1
kind: Pod
    ...
    readinessProbe:
      httpGet:
        ...
        path: /isReady`}</code>
                    ...
                    <p>
                        Hvis du har gjort alt riktig så skal du ha fått følgende respons i terminalen, og du kan gå
