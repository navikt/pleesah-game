...
export const Oppgave2 = () => {
    return (
        <Oppgaveside
            ...
            hint={{
                hint1: "https://kubernetes.io/docs/concepts/configuration/liveness-readiness-startup-probes/",
                hint2: "https://kubernetes.io/docs/reference/kubectl/generated/kubectl_get/",
                hint3: "kubectl get pods",
                hint4: "https://kubernetes.io/docs/reference/kubectl/generated/kubectl_describe/",
